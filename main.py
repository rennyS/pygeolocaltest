        ...
        if os.path.exists(data_path):
            ...
            with _open_extract_cycle_url(download_urls, country) as fh:
                data = pd.read_csv(
                    ...
                    header=None,
                    names=DATA_FIELDS,
                    dtype={"postal_code": str,"county_code": str, "county_name": str,"community_name": str},
                    na_values=NA_VALUES,
                    keep_default_na=False,
                )
...
list1 = ["eh52 6ff","eh7 4gg","EH14 5NF"]
list2 = ["EH2 2PF","EH21 6JW","EH51 9RA"]

dist = GeoDistance("GB_full")
print(dist.query_postal_code("EH52 6FF","EH21 6JW"))

"""for postcode1 in list1:
    for postcode2 in list2:
